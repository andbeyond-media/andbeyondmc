package com.rtb.andbeyondmc.appopen
...
import com.rtb.andbeyondmc.sdk.AdLoadCallback
...
import com.rtb.andbeyondmc.sdk.OnShowAdCompleteListener
...
class AppOpenAdManager(private val context: Context, adUnit: String?) {
    ...
    var fullScreenContentCallback: com.rtb.andbeyondmc.sdk.FullScreenContentCallback? = null
